<script>
  ...
  <footer>
    <p>이 홈페이지는 던전앤파이터 공식 홈페이지 리소스를 참고하여 제작되었으며, 비상업적 포트폴리오 제출용으로 사용되었습니다. <br> E-mail : soioiz@naver.com <br> &copy; 2005 NEOPLE Inc. & NEXON Korea Corporation All Rights Reserved.</p>
    <li class="flogo">
