...
<style>
.intro{position:fixed;left:0;top:0;height:100vh;background:url('/weapon-front/images/intro_logo.png') 50% 50% no-repeat #151922;z-index:200}
...
.intro .cover:after{content:'';display:block;position:absolute;left:calc(50% - 121px);bottom:-69px;width:242px;height:125px;background:url('/weapon-front/images/intro_logo.png') 50% 0 no-repeat}
